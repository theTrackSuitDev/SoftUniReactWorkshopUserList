    ...
    return (
        <tr>
            ...
            <td className="actions">
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => deleteClickHandler(user._id)}>
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fas"
                ...
                <button className="btn info-btn" title="Info" onClick={() => showDetailsHandler(user._id)}>
                    <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fas"
